                                ...
                                <tr>
                                    ...
                                    <th scope="col" wire:click="sort('nama_kategori')">Kategori
                                        <span class="float-end" style="cursor: pointer;">
                                            <i
                                                class="bi bi-arrow-up {{ $sortColumn === 'nama_kategori' && $sortDirection === 'asc' ? '' : 'text-muted' }}"></i>
                                            <i
                                                class="bi bi-arrow-down {{ $sortColumn === 'nama_kategori' && $sortDirection === 'desc' ? '' : 'text-muted' }}"></i>
                                        </span>
                                    </th>
