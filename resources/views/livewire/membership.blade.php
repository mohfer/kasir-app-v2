                                ...
                                <table class="table table-striped table-bordered mt-3">
                                    <thead class="table-primary">
                                        <tr>
                                            ...
                                            <th scope="col" wire:click="sort('diskon')">Diskon <span
                                            ...
                                            <th scope="col" wire:click="sort('tgl_berlangganan')">Tgl Berlangganan
                                                <span class="float-end" style="cursor: pointer;">
                                                    <i
                                                        class="bi bi-arrow-down {{ $sortColumn === 'tgl_berlangganan' && $sortDirection === 'asc' ? '' : 'text-muted' }}"></i>
                                                    <i
                                                        class="bi bi-arrow-up {{ $sortColumn === 'tgl_berlangganan' && $sortDirection === 'desc' ? '' : 'text-muted' }}"></i>
                                                </span>
                                            </th>
                                    ...
                                    <tbody>
                                        @foreach ($members as $key => $member)
                                            <tr>
                                                ...
                                                <td>{{ $member->nama }}</td>
                                                <td>{{ $member->diskon }}%</td>
                                                <td>{{ $member->tgl_berlangganan }}</td>
                                                <td>{{ $member->aktif }}</td>
                                                <td class="text-center"><button class="btn btn-warning"
                                                        data-bs-toggle="modal" data-bs-target="#modalUpdate"
                                                        wire:click='edit({{ $member->id }})'>Edit</button> |
